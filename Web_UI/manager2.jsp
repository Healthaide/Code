        ...
        <div class="tpl-page-container tpl-page-header-fixed">
                ...
                <div class="tpl-left-nav-item">
                    ...
                    <li class="tpl-left-nav-list">
                        <ul class="tpl-left-nav-menu">                           
                            <a href="manager.jsp" class="nav-link active">
            ...
            <div class="tpl-content-wrapper">     
                ...
                <ol class="am-breadcrumb">
                    ...
                    <li><a href="manager.jsp" class="am-icon-list">Manager List</a></li>
                    <li><a href="#" class="am-icon-plus">Add Manager</a></li>
                </ol>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" role="form" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Initial Password</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="password" class="form-control" id="inputEmail3" placeholder="Initial Password">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sd-offset-1 col-sm-10">
                                                        <p>
                                                            <input style="margin-top: 18px" class="am-btn am-btn-primary" type="submit" value="Add" onclick="add()" />
                                                        </p>
                                                    </div>
                                                </div>
                                            </form>
