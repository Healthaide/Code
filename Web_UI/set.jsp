        ...
        <div class="tpl-page-container tpl-page-header-fixed">
            ...
            <div class="tpl-content-wrapper">     
                ...
                <ol class="am-breadcrumb">
                    ...
                    <li><a href="#" class="am-icon-eraser">Modify Password</a></li>
                </ol>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" role="form" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Account Name</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="name"  class="form-control" id="inputEmail3" placeholder="Name">
                                                    </div>
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Past Password</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="password" class="form-control" id="inputEmail3" placeholder="Past Password">
                                                    </div>                                       
                                                    <label for="inputEmail3" class="col-sm-1 control-label">New Password</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="password" class="form-control" id="inputEmail3" placeholder="New Password">
                                                    </div>
                                                </div>
                                                <br><br><br>
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Confirm Password</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="password" class="form-control" id="inputEmail3" placeholder="Confirm Password">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sd-offset-1 col-sm-10">
                                                        <p>
                                                            <input style="margin-top: 38px" class="am-btn am-btn-primary" type="submit" value="confirm" onclick="" />
                                                        </p>
                                                    </div>
                                                </div>
                                            </form>
