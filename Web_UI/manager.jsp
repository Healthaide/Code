        ...
        <div class="tpl-page-container tpl-page-header-fixed">
            ...
            <div class="tpl-content-wrapper">     
                ...
                <ol class="am-breadcrumb">
                    ...
                    <li><a href="#" class="am-icon-list">Manager List</a></li>
                    <li><a href="manager2.jsp" class="am-icon-plus">Add Manager</a></li>                    
                </ol>
                <div class="tpl-portlet-components">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-group form">
                                        ...
                                        <input  style="width:220px;height:33px"type="text" name="title" class="form-control" placeholder="Search Manaer...">
                    ...
                    <div class="form-group">
                        <div class="col-sd-offset-1 col-sm-10">
                            <input style="margin-top: 18px" type="button" value="Add Manager" class="am-btn am-btn-primary" onclick="window.location.href('manager2.jsp')">
