        ...
        <div class="tpl-page-container tpl-page-header-fixed">
                ...
                <div class="tpl-left-nav-item">
                    ...
                    <li class="tpl-left-nav-list">
                        <ul class="tpl-left-nav-menu">
                            <a href="doctor1.jsp" class="nav-link active">
            ...
            <div class="tpl-content-wrapper">     
                ...
                <ol class="am-breadcrumb">
                    ...
                    <li><a href="doctor1.jsp" class="am-icon-list">Doctor List</a></li>
                    <li><a href="#" class="am-icon-plus">Add Doctor</a></li>
                </ol>
                                        ...
                                        <div class="panel-body">
                                            <form class="form-horizontal" role="form" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Hospital</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" name="hospital" class="form-control" id="inputEmail3" placeholder="Hospital">
                                                    </div>
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Department</label>
                                                    <div class="col-sm-3">
                                                        <input style="margin-left: 20px" type="text" name="department" class="form-control" id="inputEmail3" placeholder="Department">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputEmail3" class="col-sm-1 control-label">Phone Number</label>
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sd-offset-1 col-sm-10">
                                                        <p>
                                                            <input class="am-btn am-btn-primary" type="submit" value="Add" onclick="add()" />
                                                        </p>
                                                    </div>
                                                </div>
                                            </form>
